...
const ShowProjects = ({ display, setOpenProduction }) => {
  ...
  return (
    <div
      className={`flex-auto flex flex-col mt-4 gap-4 min-h-screen ${display ? "block" : "hidden"}`}
    >
            ...
            <table className="w-full bg-white">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="p-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">
                    Creation Date
                  </th>
              ...
              <tbody className="divide-y divide-gray-200">
                {projects.map((project) => (
                  <tr key={project.id} className="hover:bg-gray-50">
                    ...
                    <td className="p-3 text-sm text-gray-500 text-center hidden md:table-cell">
              ...
              >
                ...
                {project.isCompleted ? (
                  <>
                    ...
                    <button
                      className="w-full bg-green-500 hover:bg-green-600 text-white text-sm font-medium py-2 px-4 rounded transition duration-300 ease-in-out mb-2"
                      onClick={() => handleDownloadClick(project)}
                    >
                    ...
                    <button
                      className="w-full bg-green-500 hover:bg-green-600 text-white text-sm font-medium py-2 px-4 rounded transition duration-300 ease-in-out"
                      onClick={() => handleHostSite(project)}
                    >
                      Host Site
                      <svg
                  ...
                  <p className="text-gray-500">Project not completed</p>
                )}
              </div>
            ))}
          </div>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        ...
        <p className="mb-4">
          $2 will be deducted from your tokens to download this project's files.
