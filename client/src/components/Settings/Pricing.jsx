    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center w-full m-auto form-entry">
                <div className="w-full shadow-sm rounded-lg dark-applied bg-gray-100 p-4 flex flex-col justify-between">
                    <div>
                    ...
                    <button className="mt-4 outline-none text-center border-2 border-yedu-green text-yedu-green  bg-yedu-white rounded-md w-full py-2 px-4 hover:bg-yedu-green hover:text-yedu-white">
                        Subscribe Now
                    </button>
                </div>
                <div className="w-full shadow-sm rounded-lg dark-applied bg-gray-100 p-4 flex flex-col justify-between">
