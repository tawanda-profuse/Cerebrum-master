...
const TermsOfUse = ({ show, setShow }) => {
    ...
    return (
        <>
            <div
                className={`modal-backdrop ${show ? 'block' : 'hidden'}`}
            ></div>
            <dialog
            ...
            >
                ...
                <p className="text-left text-yedu-gray-text my-4">
                    Yedu AI grants you a limited, non-exclusive,
                    non-transferable, and revocable license to use our services
                    for personal or internal business purposes, in accordance
                    with these Terms. You agree not to use the service for any
                    unlawful or prohibited activities, including but not limited
                    to:
                </p>
                <ol>
                    <li className="text-yedu-gray-text my-4">
                        <strong>Violating Laws</strong>: Engaging in any
                        activity that violates any applicable law or regulation.
                    </li>
                    <li className="text-yedu-gray-text my-4">
                    ...
                    <li className="text-yedu-gray-text my-4">
                        <strong>Harmful Conduct</strong>: Transmitting harmful
                        or malicious software, or attempting to disrupt or
                        damage our systems or services.
                    </li>
                    <li className="text-yedu-gray-text my-4">
                ...
                <p className="text-left text-yedu-gray-text my-4">
                    All content and materials available on Yedu AI, including
                    but not limited to text, graphics, logos, and software, are
                    the property of Yedu AI or its licensors and are protected
                    by applicable intellectual property laws. You may not
                ...
                <p className="text-left text-yedu-gray-text my-4">
                    You may have the opportunity to submit or upload content to
                    Yedu AI. By submitting content, you grant Yedu AI a
                    worldwide, non-exclusive, royalty-free, transferable license
                    to use, reproduce, distribute, and display your content in
                    connection with our services. You represent and warrant that
                    you have the right to grant this license and that your
                ...
                <p className="text-left text-yedu-gray-text my-4">
                    Yedu AI reserves the right to suspend or terminate your
                    ...
                    immediately cease, and any data or content you have
                    submitted may no longer be accessible.
                </p>
                <h2 className="text-xl text-left font-bold underline my-6">
                ...
                <p className="text-left text-yedu-gray-text my-4">
                    ...
                    from (a) your use or inability to use the service; (b) any
                ...
                <p className="text-left text-yedu-gray-text my-4">
                    Yedu AI reserves the right to modify or replace these Terms
                    at any time. We will provide notice of any changes by
                    posting the new Terms on our website. Your continued use of
