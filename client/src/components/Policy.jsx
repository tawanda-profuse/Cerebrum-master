const Policy = ({ display, setDisplay }) => {
    return (
        <dialog
            className={`w-[80vw] md:w-[50vw] overflow-y-scroll max-h-[80vh] absolute top-[10%] left-[50%] -translate-x-2/4 z-50 shadow-xl shadow-yedu-dark-gray py-4 px-8 rounded-lg ${display ? 'block' : 'hidden'}`}
        >
